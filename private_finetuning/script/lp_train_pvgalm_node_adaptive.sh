...
json_data=$(jq --arg output_dir $CHECKPOINT_DIR/$MODEL_TYPE/dp_lora/$DPTYPE/$LR'_'$EPSILON'_'$SCALE'_c'$CNORM'_b'$BSIZE'_n'$NEGK'_r'$RANK'_K'$DCAP \
               --arg logging_dir $LOG_DIR/$MODEL_TYPE/$LR \
               --arg dataset_name $SDOMAIN \
               --arg train_path $PROCESSED_DIR/train.text.$DPTYPE'_K'$DCAP.jsonl \
